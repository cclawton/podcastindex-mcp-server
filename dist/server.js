    ...
    server.setRequestHandler(CallToolRequestSchema, async (request) => {
        ...
        try {
            if (toolRequiresAuth(name) && !validateAuthCredentials()) {
                throw new AuthenticationError('Missing API credentials. Set PODCASTINDEX_API_KEY and PODCASTINDEX_API_SECRET environment variables. ' +
            ...
            const payload = action ? { ...result, action } : result;
            return {
