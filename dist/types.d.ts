...
export declare class PodcastIndexError extends Error {
    statusCode?: number | undefined;
    responseBody?: unknown | undefined;
    constructor(message: string, statusCode?: number | undefined, responseBody?: unknown | undefined);
}
export declare class AuthenticationError extends PodcastIndexError {
    constructor(message?: string);
}
export declare class RateLimitError extends PodcastIndexError {
    constructor(message?: string);
}
export declare class ValidationError extends PodcastIndexError {
    constructor(message: string);
}
